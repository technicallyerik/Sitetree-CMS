...
namespace Sitetree.Example.Migrations
{
    ...
    public class ExampleWebsite : Migration
    {
        ...
        {
            Delete.FromTable("PageData").AllRows();
            Delete.FromTable("Pages").AllRows();
            Delete.FromTable("SiteDomains").AllRows();
            Delete.FromTable("Sites").AllRows();
        }
    }
}